...
<fieldset>
	...
	<legend accesskey="R" tabindex="<?php echo tab_index() ?>">Detail Ruangan</legend>
	...
	<p>
		<label for="bookable">Dapat dipinjam</label>
		<?php
		$field = 'bookable';
		...
		?>
		<p class="hint">Check pada box untuk memungkinkan ruangan bisa dipinjam.</p>
	</p>
...
<fieldset>
	...
	<br>
	<div>Tambahkan foto ruangan.</div>
	<br>
	...
	<p>
		...
		<p class="hint">Mengunggah foto akan <span>mengganti</span> yang lama.</p>
	</p>
	...
	<p>
		<label for="photo_delete">Hapus foto?</label>
		<?php
		$field = 'photo_delete';
		echo form_hidden($field, '0');
		echo form_checkbox(array(
		...
		?>
		<p class="hint">Check box ini untuk <span>menghapus foto</span> tanpa menambahkan foto baru.</p>
	</p>
