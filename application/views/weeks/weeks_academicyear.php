...
<fieldset style="width:50%">
	...
	<legend accesskey="A" tabindex="<?= tab_index() ?>">Periode</legend>

	<p>
		<label for="date_start" class="required">Tanggal mulai:</label>
		<?php
		$field = 'date_start';
	...
	<p>
		<label for="date_end" class="required">Tanggal akhir:</label>
		<?php
		$field = 'date_end';
