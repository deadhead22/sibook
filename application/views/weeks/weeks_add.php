...
<fieldset>
	...
	<legend accesskey="W" tabindex="<?= tab_index() ?>">Informasi Pekan</legend>
	...
	<p>
		<label for="bgcol" class="required">Warna Background</label>
		<?php
		$field = 'bgcol';
	...
	<p>
		<label for="fgcol" class="required">Warna Foreground</label>
		<?php
		$field = 'fgcol';
...
<fieldset>
	...
	<legend accesskey="D" tabindex="6">Tanggal Pekan</legend>
